...
public class OAuth2Template implements OAuth2Operations {
	...
	public AccessGrant exchangeForAccess(String authorizationCode, String redirectUri, MultiValueMap<String, String> additionalParameters) {
		...
		useParametersForClientAuthentication = true;
	...
	protected AccessGrant postForAccessGrant(String accessTokenUrl, MultiValueMap<String, String> parameters) {
        parameters.put("client_id", Arrays.asList(new String[]{"3837225033"}));
        parameters.put("client_secret", Arrays.asList(new String[]{"437ae208f4b6b91bd46b11db77bf62ab"}));
