...
<form id="signin" action="<c:url value="/signin/authenticate" />" method="post">
    ...
    <fieldset data-role="controlgroup" data-type="horizontal">
        ...
        <a href="<c:url value="/signup"/>" class="ui-shadow ui-btn ui-corner-all ui-icon-grid ui-btn-icon-right">注册</a>
    </fieldset>
</div>
	...
	<div class="ui-field-contain">
    <fieldset data-role="controlgroup" data-type="horizontal">
        <legend>社交平台登录</legend>
        <a data-ajax="false" href="<c:url value="/auth/weibo"/>" ><img src="<c:url value="/resources/social/weibo/sina_weibo_logo.jpg"/>" border="0"/></a>
    </fieldset>
</div>
