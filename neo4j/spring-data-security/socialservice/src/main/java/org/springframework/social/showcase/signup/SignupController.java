...
public class SignupController {
	...
	private Account createAccount(SignupForm form, BindingResult formBinding) {
		try {
			...
			// add corresponding account in neo4j
			if(neo4jAccountRepository.findById(account.getUsername())==null) {
    			Neo4jAccount neo4jAccount = new Neo4jAccount(account.getUsername(),account.getLastName()+" "+account.getFirstName());
