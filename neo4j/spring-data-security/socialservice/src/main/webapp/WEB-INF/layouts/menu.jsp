...
<h4><a href="<c:url value="/weibo"/>">Weibo</a></h4>
<social:connected provider="weibo">
<ul class="menu">
	<li><a href="<c:url value="/weibo"/>">User Profile</a></li>
	<li><a href="<c:url value="/weibo/import"/>">Import friends</a></li>
</ul>
</social:connected>