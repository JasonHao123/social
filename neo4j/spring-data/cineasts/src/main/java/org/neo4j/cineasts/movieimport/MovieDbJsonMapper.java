...
public class MovieDbJsonMapper {
    ...
    public void mapToMovie(Map data, Movie movie) {
        try {
            ...
            movie.setLanguage((String) extractFirst(data,"spoken_languages","name"));
...
*/
    ...
    public Roles mapToRole(String roleString) {
        ...
        if (roleString.equals("Producer")) {
            return Roles.PRODUCER;
        }
        if (roleString.equals("Original Music Composer")) {
            return Roles.OriginalMusicComposer;
        }
        
        if (roleString.equals("Editor")) {
            return Roles.Editor;
        }
        if (roleString.equals("Sound Editor")) {
            return Roles.SoundEditor;
        }
        return null;
    }
}
