...
<input type="hidden" name="mode" value="signup" />
  ...
  <br><br>
    ...
    <a class="ui-shadow ui-btn ui-corner-all ui-icon-back ui-btn-icon-right" data-rel="back">Back</a>
        <button class="ui-shadow ui-btn ui-corner-all ui-icon-home ui-btn-icon-right" type="submit"><spring:message code="page.label.signup.submit" text="Submit" /></button>
